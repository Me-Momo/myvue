...
const actions = {
  ...
  getRadio({
      ...
      Vue.http.get(`http://http://139.199.178.135:1234/radio`)
        .then((res) => {
    ...
    getSong({
      ...
      commit("toggleAudioLoadding", true);
      Vue.http.get(`http://http://139.199.178.135:1234/song?id=${id}`)
        .then((res) => {
          var audio = JSON.parse(res.body)
            .song;
          var info = {
    ...
    search({
      ...
      commit("toggleAudioLoadding", true);
      Vue.http.get(`http://http://139.199.178.135:1234/search?${param}`)
        .then((res) => {
    ...
    getPlaylist({
      ...
      commit("toggleAudioLoadding", true);
      Vue.http.get(`http://http://139.199.178.135:1234/playlist?id=${id}`)
        .then((res) => {
          var audioList = JSON.parse(res.body);
          var info = {
            audioList: audioList,
    ...
    getLyric({
      ...
      commit("toggleAudioLoadding", true);
      Vue.http.get(`http://http://139.199.178.135:1234/songLyric?id=${id}`)
        .then((res) => {
